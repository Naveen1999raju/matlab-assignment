...
% from the
% <https://trace.ncbi.nlm.nih.gov/Traces/sra/?run=SRR054715 NCBI FTP site>. 
%

%%
% This example assumes that you:
% 
% (1) downloaded the data containing the unmapped short read and converted
% it to FASTQ formatted files using the
% <http://www.ncbi.nlm.nih.gov/Traces/sra/sra.cgi?view=software NCBI SRA
% Toolkit>.
% 
...
%     paired-end ChIP-Seq data", BMC Bioinformatics, 11:81, 2010. 
%
% [2] Li H. and Durbin R., "Fast and accurate short read alignment with
%     Burrows-Wheeler transform", Bioinformatics, 25(14):1754-60, 2009.
%
% [3] Li, H., et al., "The Sequence Alignment/map (SAM) Format and
%     SAMtools", Bioinformatics, 25(16):2078-9, 2009.
%
% [4] Jothi R., et al., "Genome-wide identification of in vivo protein-DNA
%     binding sites from ChIP-Seq data", Nucleic Acids Research,
%     36(16):5221-31, 2008. 
%
...
%     with flow cell sequencing", Journal of Endocrinology, 201(1):1-13,
%     2009. 
%
% [6] Ramsey S.A., et al., "Genome-wide histone acetylation data improve
%     prediction of mammalian transcription factor binding sites",
%     Bioinformatics, 26(17):2071-5, 2010.
